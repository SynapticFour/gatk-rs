//! L4: PairHMM trace for P12 site 92318315 (T/A tier-3 hom-alt, Java PL 135,9,0 AD 0,3).
//! Run: `P12_PHASE_E=1 P12_REFERENCE=parity/realworld/assets/hs37d5.simple.fa cargo test -p gatk-haplotypecaller p12_site_92318315 --release -- --ignored --nocapture`
...
#[test]
#[ignore = "P12 BAM: 92318315 PairHMM trace"]
fn p12_site_92318315_pairhmm_trace() {
