//! L4: PairHMM trace for P12 site 92318199 (C/T sparse hom-alt, Java PL 45,3,0 AD 0,1).
//! Run: `P12_PHASE_E=1 P12_REFERENCE=parity/realworld/assets/hs37d5.simple.fa cargo test -p gatk-haplotypecaller p12_site_92318199 --release -- --ignored --nocapture`
...
#[test]
#[ignore = "P12 BAM: 92318199 PairHMM trace"]
fn p12_site_92318199_pairhmm_trace() {
    ...
    eprintln!("=== Java target ===\nPOS={POS} PL=45,3,0 GQ=3 AD=0,1 DP=1");
