//! L4: PairHMM trace for P12 site 92318325 (A/G sparse hom-alt, Java PL 135,9,0 AD 0,3).
//! Run: `P12_PHASE_E=1 P12_REFERENCE=parity/realworld/assets/hs37d5.simple.fa cargo test -p gatk-haplotypecaller p12_site_92318325 --release -- --ignored --nocapture`
...
const POS: u64 = 92318325;
const REGION_LO: u64 = 92318290;
const REGION_HI: u64 = 92318521;
...
#[test]
#[ignore = "P12 BAM: 92318325 PairHMM trace"]
fn p12_site_92318325_pairhmm_trace() {
    ...
    eprintln!("=== Java target ===\nPOS={POS} PL=135,9,0 GQ=9 AD=0,3 DP=3");
