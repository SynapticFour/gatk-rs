...
"${repo_root}/scripts/parity/ensure_mismatch_triage.sh" p11
...
triage = pathlib.Path(sys.argv[1]) / "parity" / "reports" / "p11_mismatch_triage.jsonl"
...
if high_open:
    ...
    raise SystemExit(1)
print("[p11-triage] schema/disposition checks passed")
PY
