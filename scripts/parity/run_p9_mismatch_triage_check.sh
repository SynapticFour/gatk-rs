...
"${repo_root}/scripts/parity/ensure_mismatch_triage.sh" p9
...
triage = pathlib.Path(sys.argv[1]) / "parity" / "reports" / "p9_mismatch_triage.jsonl"
...
if high_open:
    ...
    raise SystemExit(1)
print("[p9-triage] schema/disposition checks passed")
PY
